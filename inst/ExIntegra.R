#-------------------------------------------------------#
#--- Generating the integrated functions of Z splines ---#
#-------------------------------------------------------#
k = 3 # order
N = 3 # support level
...
int_ZB = integra(ZB$bs) # generating the derivative of the Z-spline basis

plot(int_ZB) # plotting the derivative of the Z-spline basis
